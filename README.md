...
- **Paste this repo URL** — `https://github.com/namluu1998/secure-financial-agents` — then pick the agents and verticals you want from the marketplace list, or
...
```bash
# Add the marketplace
claude plugin marketplace add namluu1998/secure-financial-agents

# Core skills + connectors (install first)
claude plugin install financial-analysis@secure-claude-for-financial-services

# Named agents — pick the ones you want
claude plugin install pitch-agent@secure-claude-for-financial-services
claude plugin install gl-reconciler@secure-claude-for-financial-services
claude plugin install market-researcher@secure-claude-for-financial-services

# Vertical skill bundles
claude plugin install investment-banking@secure-claude-for-financial-services
claude plugin install equity-research@secure-claude-for-financial-services
```
...
| **[quality-engineering](./plugins/vertical-plugins/quality-engineering)** | QC test planning, test case design, API/security testing, defect reporting, concise Vietnamese QC feedback, release gates, and frontend design skill sources. |
...
```bash
claude plugin install claude-for-msft-365-install@secure-claude-for-financial-services
...
| rewrite-qc-feedback-vn | — | Rewrite raw technical notes into concise Vietnamese QC responses for teams or customers |
