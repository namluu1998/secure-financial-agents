...
#
# `output_schema` is a required harness-side boundary for untrusted readers.
# The Managed Agents API does not enforce it, so live deployment fails closed
# below until the caller provides a validation-capable orchestration layer.
#
